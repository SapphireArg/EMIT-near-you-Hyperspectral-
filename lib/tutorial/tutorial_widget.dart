                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'c05svi4v' /* Here you can find the Tutorial... */,
                                      ),
                                  ...
                                  FlutterFlowYoutubePlayer(
                                    url:
                                        'https://www.youtube.com/watch?v=XzSEqdiS2aE',
                                    autoPlay: false,
                                    looping: true,
                                    mute: false,
                                    showControls: true,
                                  ...
                                  FlutterFlowYoutubePlayer(
                                    url:
                                        'https://www.youtube.com/watch?v=A7ndyecolck',
                                    autoPlay: false,
                                    looping: true,
                                    mute: false,
                                    showControls: true,
                                  ...
                                  FlutterFlowYoutubePlayer(
                                    url:
                                        'https://www.youtube.com/watch?v=FKvlPP2tG9Y',
                                    autoPlay: false,
                                    looping: true,
                                    mute: false,
                                    showControls: true,
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'auyqin8j' /* Here you can check the EMIT Op... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                  ),
